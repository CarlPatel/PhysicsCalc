				...
				<Grid.Row only="computer and tablet">
					...
					<Menu widths={6} inverted borderless secondary>
						<Menu.Item 
							...
							as={Link}
							to={process.env.PUBLIC_URL + "/forces"}
						>
				        	Forces
						</Menu.Item>
						...
						onClick={this.handleItemClick}
						as={Link}
						to={process.env.PUBLIC_URL + "/kinomatics"}
						>
							Kinomatics
						</Menu.Item>
						...
						onClick={this.handleItemClick}
						as={Link}
						to={process.env.PUBLIC_URL + "/circular"}
						>
							Circular Motion
						</Menu.Item>
						...
						onClick={this.handleItemClick}
						as={Link}
						to={process.env.PUBLIC_URL + "/gravation"}
						>
							Universal Gravation
						</Menu.Item>
						...
						onClick={this.handleItemClick}
						as={Link}
						to={process.env.PUBLIC_URL + "/equations"}
						>
							Equations
						</Menu.Item>
